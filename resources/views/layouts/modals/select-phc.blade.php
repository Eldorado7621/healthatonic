<!-- change cphc-- Modal -->
	<div class="col-md-12 modal modal-default fade" id="getSchedulePatients" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
    <div class="modal-dialog" role="document" style="width:800px;">
	 ...
	 <!--modal body-->
	  <div class="modal-body" >
	   ...
	   <form method="post" action="{{route('getSchedulePatients')}}">
	    @csrf
