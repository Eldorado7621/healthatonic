<!-- change cphc-- Modal -->
	<div class="col-md-12 modal modal-default fade" id="view_need" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
    <div class="modal-dialog" role="document" style="width:800px;">
	 ...
	 <!--modal body-->
	  <div class="modal-body"  style="width:800px;">
	    ...
	    <form method="post" action="{{route('view_need')}}" enctype="multipart/form-data">
	    @csrf
			...
			<input type="submit" value="VIEW ALL RECORDS" class="btn btn-success"/>
